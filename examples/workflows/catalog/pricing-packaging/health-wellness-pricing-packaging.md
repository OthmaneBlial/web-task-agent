# Health and Wellness: Pricing and Packaging

**Category:** Pricing and Packaging

Research value metrics and buying friction before changing a pricing page or paywall. Focused on non-diagnostic consumer wellbeing, fitness, coaching, and care-adjacent workflows.
...
```bash
web-task-agent workflow run health-wellness-pricing-packaging \
