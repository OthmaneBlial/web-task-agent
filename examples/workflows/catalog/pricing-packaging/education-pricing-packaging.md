...
Research value metrics and buying friction before changing a pricing page or paywall. Focused on learning experiences, study workflows, instructors, and education operations.
...
```bash
web-task-agent workflow run education-pricing-packaging \
