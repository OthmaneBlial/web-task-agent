# Fintech: Pricing and Packaging

**Category:** Pricing and Packaging

Research value metrics and buying friction before changing a pricing page or paywall. Focused on financial workflows, financial planning, payments, and compliance-sensitive products.
...
```bash
web-task-agent workflow run fintech-pricing-packaging \
