# Local Business: Feature Gap Discovery

**Category:** Feature Gap Discovery

Find the smallest high-signal product gap instead of collecting an unranked feature wish list. Focused on service businesses, bookings, repeat customers, and day-to-day operations.
...
```bash
web-task-agent workflow run local-business-feature-gap \
