# E-commerce: Feature Gap Discovery

**Category:** Feature Gap Discovery

Find the smallest high-signal product gap instead of collecting an unranked feature wish list. Focused on merchant operations, conversion, retention, fulfilment, and customer support.
...
```bash
web-task-agent workflow run ecommerce-feature-gap \
