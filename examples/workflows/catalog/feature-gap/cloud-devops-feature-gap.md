# Cloud and DevOps: Feature Gap Discovery

**Category:** Feature Gap Discovery

Find the smallest high-signal product gap instead of collecting an unranked feature wish list. Focused on deployment, CI/CD, infrastructure, reliability, and cloud operations.
...
```bash
web-task-agent workflow run cloud-devops-feature-gap \
