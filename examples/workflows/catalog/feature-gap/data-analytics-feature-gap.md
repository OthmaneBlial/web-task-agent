# Data and Analytics: Feature Gap Discovery

**Category:** Feature Gap Discovery

Find the smallest high-signal product gap instead of collecting an unranked feature wish list. Focused on BI, data operations, governance, experimentation, and analytics workflows.
...
```bash
web-task-agent workflow run data-analytics-feature-gap \
