# Health and Wellness: Feature Gap Discovery

**Category:** Feature Gap Discovery

Find the smallest high-signal product gap instead of collecting an unranked feature wish list. Focused on non-diagnostic consumer wellbeing, fitness, coaching, and care-adjacent workflows.
...
```bash
web-task-agent workflow run health-wellness-feature-gap \
