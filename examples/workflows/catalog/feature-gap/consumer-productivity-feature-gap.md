# Consumer Productivity: Feature Gap Discovery

**Category:** Feature Gap Discovery

Find the smallest high-signal product gap instead of collecting an unranked feature wish list. Focused on personal organization, planning, notes, habits, and everyday digital tools.
...
```bash
web-task-agent workflow run consumer-productivity-feature-gap \
