# Climate and Sustainability: Feature Gap Discovery

**Category:** Feature Gap Discovery

Find the smallest high-signal product gap instead of collecting an unranked feature wish list. Focused on sustainability reporting, resource efficiency, climate operations, and environmental products.
...
```bash
web-task-agent workflow run climate-sustainability-feature-gap \
