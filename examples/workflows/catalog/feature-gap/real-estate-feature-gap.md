# Real Estate: Feature Gap Discovery

**Category:** Feature Gap Discovery

Find the smallest high-signal product gap instead of collecting an unranked feature wish list. Focused on property search, property operations, agents, landlords, and tenant workflows.
...
```bash
web-task-agent workflow run real-estate-feature-gap \
