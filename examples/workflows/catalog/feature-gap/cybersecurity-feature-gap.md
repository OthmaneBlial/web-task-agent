# Cybersecurity: Feature Gap Discovery

**Category:** Feature Gap Discovery

Find the smallest high-signal product gap instead of collecting an unranked feature wish list. Focused on security operations, identity, application security, and developer security tooling.
...
```bash
web-task-agent workflow run cybersecurity-feature-gap \
