# HR and Recruiting: Feature Gap Discovery

**Category:** Feature Gap Discovery

Find the smallest high-signal product gap instead of collecting an unranked feature wish list. Focused on hiring, employee operations, learning, performance, and people systems.
...
```bash
web-task-agent workflow run hr-recruiting-feature-gap \
