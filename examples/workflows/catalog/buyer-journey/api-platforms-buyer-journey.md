# API Platforms: Buyer Journey

**Category:** Buyer Journey

Reveal the moments that create momentum or abandonment between discovery and adoption. Focused on API design, observability, gateways, developer portals, and integration tooling.
...
```bash
web-task-agent workflow run api-platforms-buyer-journey \
