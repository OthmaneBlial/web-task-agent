...
Reveal the moments that create momentum or abandonment between discovery and adoption. Focused on property search, property operations, agents, landlords, and tenant workflows.
...
```bash
web-task-agent workflow run real-estate-buyer-journey \
