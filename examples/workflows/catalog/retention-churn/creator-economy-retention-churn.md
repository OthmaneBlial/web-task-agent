# Creator Economy: Retention and Churn

**Category:** Retention and Churn

Research why users stay, leave, or downgrade, then turn findings into retention experiments. Focused on content production, audience growth, creator businesses, and media workflows.
...
```bash
web-task-agent workflow run creator-economy-retention-churn \
