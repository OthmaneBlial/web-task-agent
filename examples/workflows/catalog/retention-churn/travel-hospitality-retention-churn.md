# Travel and Hospitality: Retention and Churn

**Category:** Retention and Churn

Research why users stay, leave, or downgrade, then turn findings into retention experiments. Focused on trip planning, property operations, guest experience, and service logistics.
...
```bash
web-task-agent workflow run travel-hospitality-retention-churn \
