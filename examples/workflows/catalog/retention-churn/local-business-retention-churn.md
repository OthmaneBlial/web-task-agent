# Local Business: Retention and Churn

**Category:** Retention and Churn

Research why users stay, leave, or downgrade, then turn findings into retention experiments. Focused on service businesses, bookings, repeat customers, and day-to-day operations.
...
```bash
web-task-agent workflow run local-business-retention-churn \
