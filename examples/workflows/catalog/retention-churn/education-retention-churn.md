# Education: Retention and Churn

**Category:** Retention and Churn

Research why users stay, leave, or downgrade, then turn findings into retention experiments. Focused on learning experiences, study workflows, instructors, and education operations.
...
```bash
web-task-agent workflow run education-retention-churn \
