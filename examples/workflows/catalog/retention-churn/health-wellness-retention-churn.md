# Health and Wellness: Retention and Churn

**Category:** Retention and Churn

Research why users stay, leave, or downgrade, then turn findings into retention experiments. Focused on non-diagnostic consumer wellbeing, fitness, coaching, and care-adjacent workflows.
...
```bash
web-task-agent workflow run health-wellness-retention-churn \
