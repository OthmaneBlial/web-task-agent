# Data and Analytics: Retention and Churn

**Category:** Retention and Churn

Research why users stay, leave, or downgrade, then turn findings into retention experiments. Focused on BI, data operations, governance, experimentation, and analytics workflows.
...
```bash
web-task-agent workflow run data-analytics-retention-churn \
