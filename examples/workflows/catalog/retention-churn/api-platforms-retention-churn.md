# API Platforms: Retention and Churn

**Category:** Retention and Churn

Research why users stay, leave, or downgrade, then turn findings into retention experiments. Focused on API design, observability, gateways, developer portals, and integration tooling.
...
```bash
web-task-agent workflow run api-platforms-retention-churn \
