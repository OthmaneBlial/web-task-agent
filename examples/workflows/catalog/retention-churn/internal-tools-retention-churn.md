# Internal Tools: Retention and Churn

**Category:** Retention and Churn

Research why users stay, leave, or downgrade, then turn findings into retention experiments. Focused on operations consoles, approvals, back-office workflows, and knowledge systems.
...
```bash
web-task-agent workflow run internal-tools-retention-churn \
