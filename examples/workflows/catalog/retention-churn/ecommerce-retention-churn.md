# E-commerce: Retention and Churn

**Category:** Retention and Churn

Research why users stay, leave, or downgrade, then turn findings into retention experiments. Focused on merchant operations, conversion, retention, fulfilment, and customer support.
...
```bash
web-task-agent workflow run ecommerce-retention-churn \
