# HR and Recruiting: Integration and Partnership

**Category:** Integration and Partnership

Prioritize integrations and ecosystem partners according to user pull and mutual value. Focused on hiring, employee operations, learning, performance, and people systems.
...
```bash
web-task-agent workflow run hr-recruiting-integration-partnership \
