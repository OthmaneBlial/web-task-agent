# Creator Economy: Competitor Map

**Category:** Competitor Map

Map direct and adjacent alternatives so a team can choose where not to compete. Focused on content production, audience growth, creator businesses, and media workflows.
...
```bash
web-task-agent workflow run creator-economy-competitor-map \
