# Internal Tools: Competitor Map

**Category:** Competitor Map

Map direct and adjacent alternatives so a team can choose where not to compete. Focused on operations consoles, approvals, back-office workflows, and knowledge systems.
...
```bash
web-task-agent workflow run internal-tools-competitor-map \
