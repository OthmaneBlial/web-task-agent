# Cybersecurity: Competitor Map

**Category:** Competitor Map

Map direct and adjacent alternatives so a team can choose where not to compete. Focused on security operations, identity, application security, and developer security tooling.
...
```bash
web-task-agent workflow run cybersecurity-competitor-map \
