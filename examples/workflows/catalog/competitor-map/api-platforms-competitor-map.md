# API Platforms: Competitor Map

**Category:** Competitor Map

Map direct and adjacent alternatives so a team can choose where not to compete. Focused on API design, observability, gateways, developer portals, and integration tooling.
...
```bash
web-task-agent workflow run api-platforms-competitor-map \
