# Consumer Productivity: Content Demand

**Category:** Content Demand

Find content topics with evidence of a real unanswered question, not merely high-volume keywords. Focused on personal organization, planning, notes, habits, and everyday digital tools.
...
```bash
web-task-agent workflow run consumer-productivity-content-demand \
