# Local Business: Launch Positioning

**Category:** Launch Positioning

Convert researched evidence into a focused launch narrative and proof plan. Focused on service businesses, bookings, repeat customers, and day-to-day operations.
...
```bash
web-task-agent workflow run local-business-launch-positioning \
