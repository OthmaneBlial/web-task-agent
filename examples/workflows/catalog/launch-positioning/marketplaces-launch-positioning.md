# Marketplaces: Launch Positioning

**Category:** Launch Positioning

Convert researched evidence into a focused launch narrative and proof plan. Focused on supply-demand platforms, trust, matching, liquidity, and provider operations.
...
```bash
web-task-agent workflow run marketplaces-launch-positioning \
