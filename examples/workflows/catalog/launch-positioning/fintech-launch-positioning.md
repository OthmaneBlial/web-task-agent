# Fintech: Launch Positioning

**Category:** Launch Positioning

Convert researched evidence into a focused launch narrative and proof plan. Focused on financial workflows, financial planning, payments, and compliance-sensitive products.
...
```bash
web-task-agent workflow run fintech-launch-positioning \
