...
Build a falsifiable validation plan around a concrete product hypothesis. Focused on security operations, identity, application security, and developer security tooling.
...
```bash
web-task-agent workflow run cybersecurity-product-validation \
