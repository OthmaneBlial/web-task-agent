...
Build a falsifiable validation plan around a concrete product hypothesis. Focused on merchant operations, conversion, retention, fulfilment, and customer support.
...
```bash
web-task-agent workflow run ecommerce-product-validation \
