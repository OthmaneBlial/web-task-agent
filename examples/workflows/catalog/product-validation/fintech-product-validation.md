...
Build a falsifiable validation plan around a concrete product hypothesis. Focused on financial workflows, financial planning, payments, and compliance-sensitive products.
...
```bash
web-task-agent workflow run fintech-product-validation \
