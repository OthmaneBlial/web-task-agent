# Local Business: Product Validation

**Category:** Product Validation

Build a falsifiable validation plan around a concrete product hypothesis. Focused on service businesses, bookings, repeat customers, and day-to-day operations.
...
```bash
web-task-agent workflow run local-business-product-validation \
