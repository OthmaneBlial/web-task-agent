# Health and Wellness: Product Validation

**Category:** Product Validation

Build a falsifiable validation plan around a concrete product hypothesis. Focused on non-diagnostic consumer wellbeing, fitness, coaching, and care-adjacent workflows.
...
```bash
web-task-agent workflow run health-wellness-product-validation \
