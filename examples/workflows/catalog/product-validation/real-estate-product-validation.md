# Real Estate: Product Validation

**Category:** Product Validation

Build a falsifiable validation plan around a concrete product hypothesis. Focused on property search, property operations, agents, landlords, and tenant workflows.
...
```bash
web-task-agent workflow run real-estate-product-validation \
