# Consumer Productivity: Product Validation

**Category:** Product Validation

Build a falsifiable validation plan around a concrete product hypothesis. Focused on personal organization, planning, notes, habits, and everyday digital tools.
...
```bash
web-task-agent workflow run consumer-productivity-product-validation \
