# HR and Recruiting: Audience Segmentation

**Category:** Audience Segmentation

Separate lookalike audiences by job, trigger, and desired outcome. Focused on hiring, employee operations, learning, performance, and people systems.
...
```bash
web-task-agent workflow run hr-recruiting-audience-segmentation \
