# Marketplaces: Audience Segmentation

**Category:** Audience Segmentation

Separate lookalike audiences by job, trigger, and desired outcome. Focused on supply-demand platforms, trust, matching, liquidity, and provider operations.
...
```bash
web-task-agent workflow run marketplaces-audience-segmentation \
