# Fintech: Audience Segmentation

**Category:** Audience Segmentation

Separate lookalike audiences by job, trigger, and desired outcome. Focused on financial workflows, financial planning, payments, and compliance-sensitive products.
...
```bash
web-task-agent workflow run fintech-audience-segmentation \
