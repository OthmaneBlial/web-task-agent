...
Separate lookalike audiences by job, trigger, and desired outcome. Focused on merchant operations, conversion, retention, fulfilment, and customer support.
...
```bash
web-task-agent workflow run ecommerce-audience-segmentation \
