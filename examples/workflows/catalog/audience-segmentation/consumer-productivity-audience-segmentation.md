# Consumer Productivity: Audience Segmentation

**Category:** Audience Segmentation

Separate lookalike audiences by job, trigger, and desired outcome. Focused on personal organization, planning, notes, habits, and everyday digital tools.
...
```bash
web-task-agent workflow run consumer-productivity-audience-segmentation \
