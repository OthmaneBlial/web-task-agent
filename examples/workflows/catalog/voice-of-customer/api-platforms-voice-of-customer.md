# API Platforms: Voice of Customer

**Category:** Voice of Customer

Turn recurring public complaints and requests into a traceable customer-problem brief. Focused on API design, observability, gateways, developer portals, and integration tooling.
...
```bash
web-task-agent workflow run api-platforms-voice-of-customer \
