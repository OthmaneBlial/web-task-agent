# Data and Analytics: Voice of Customer

**Category:** Voice of Customer

Turn recurring public complaints and requests into a traceable customer-problem brief. Focused on BI, data operations, governance, experimentation, and analytics workflows.
...
```bash
web-task-agent workflow run data-analytics-voice-of-customer \
