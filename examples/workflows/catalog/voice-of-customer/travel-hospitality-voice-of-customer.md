# Travel and Hospitality: Voice of Customer

**Category:** Voice of Customer

Turn recurring public complaints and requests into a traceable customer-problem brief. Focused on trip planning, property operations, guest experience, and service logistics.
...
```bash
web-task-agent workflow run travel-hospitality-voice-of-customer \
