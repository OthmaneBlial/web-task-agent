# Real Estate: Voice of Customer

**Category:** Voice of Customer

Turn recurring public complaints and requests into a traceable customer-problem brief. Focused on property search, property operations, agents, landlords, and tenant workflows.
...
```bash
web-task-agent workflow run real-estate-voice-of-customer \
