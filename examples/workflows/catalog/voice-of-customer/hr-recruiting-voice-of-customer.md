# HR and Recruiting: Voice of Customer

**Category:** Voice of Customer

Turn recurring public complaints and requests into a traceable customer-problem brief. Focused on hiring, employee operations, learning, performance, and people systems.
...
```bash
web-task-agent workflow run hr-recruiting-voice-of-customer \
