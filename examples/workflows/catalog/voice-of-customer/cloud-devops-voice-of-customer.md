# Cloud and DevOps: Voice of Customer

**Category:** Voice of Customer

Turn recurring public complaints and requests into a traceable customer-problem brief. Focused on deployment, CI/CD, infrastructure, reliability, and cloud operations.
...
```bash
web-task-agent workflow run cloud-devops-voice-of-customer \
