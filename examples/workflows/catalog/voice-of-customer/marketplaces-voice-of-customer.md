# Marketplaces: Voice of Customer

**Category:** Voice of Customer

Turn recurring public complaints and requests into a traceable customer-problem brief. Focused on supply-demand platforms, trust, matching, liquidity, and provider operations.
...
```bash
web-task-agent workflow run marketplaces-voice-of-customer \
