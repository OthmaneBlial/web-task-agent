...
The standard test command currently runs 112 unit tests and 3 integration tests. It also regenerates workflow/docs outputs and rejects drift before a change can merge.
