...
| Qualité et dérive | Livré localement | Build, 116 tests unitaires, 4 intégrations, génération, 305 liens Markdown, audit des secrets de publication et audit des dépendances de production dans la CI |
