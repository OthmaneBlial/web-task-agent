...
export class LlmService {
  ...
  async expandAgentResearchQueries(input: {
    ...
    const prompt = [
      ...
      "- Prefer natural-language queries that lead to readable articles, forums, docs, reviews, or app-store pages.",
      ...
      "- Avoid site: operators, long boolean chains, APK download surfaces, and mod/premium/unlocked wording.",
